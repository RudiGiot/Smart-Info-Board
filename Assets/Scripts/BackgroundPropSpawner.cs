...
public class BackgroundPropSpawner : MonoBehaviour
{
	...
	IEnumerator Spawn ()
	{
		...
		GameObject movingProps = GameObject.Find("movingProps");
		Rigidbody2D propInstance = Instantiate(backgroundProp, spawnPos, Quaternion.identity, movingProps.transform) as Rigidbody2D;
